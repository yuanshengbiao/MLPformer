...
class MLP_decoder(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.seq_len = configs.seq_len_decoder
    ...
    def forward(self, x, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        x = x.permute(0, 2, 1)    #(32,512,144)
        #print("decoder_x.shape:",x.shape)
        ...
        #x = x.reshape(self.batch_size, self.n_heads, int(self.d_model / self.n_heads), self.seq_len + self.label_len)
        x = x.reshape(self.batch_size, self.n_heads, self.d_model//self.n_heads, self.seq_len)
        return (x,None)
